...
const PizzaViewerComponent: React.FC = () => {
    ...
    return (
        <div className='pizza h-screen relative flex flex-col items-center overflow-hidden'>
            <h1 className='pizza__title text-white relative text-6xl text-center w-full mt-5'>
                Mr. Pizza
            </h1>
